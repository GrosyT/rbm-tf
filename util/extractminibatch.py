def extractminibatch(kk, minibatch_num, batchsize, x, opts):
    ...
    #                x    : data
    #             opts    ; opts struct
    batch_start = minibatch_num * batchsize  # -o: batch_start = minibatch_num - 1 * batchsize + 1 problem with
    batch_end = (minibatch_num + 1) * batchsize            # matlab index starting at 1 and python at 0
    n_samples = x.shape[0]
